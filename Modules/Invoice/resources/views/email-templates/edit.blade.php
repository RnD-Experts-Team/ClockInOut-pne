...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-black-900">Edit Email Template</h1>
        <p class="mt-2 text-sm text-black-600">Update email template: {{ $template->name }}</p>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('invoice.email-templates.update', $template->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <textarea id="body" 
                          name="body" 
                          required
                          class="hidden">{{ old('body', $template->body) }}</textarea>
