...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-black-900">Edit Email Recipient</h1>
        <p class="mt-2 text-sm text-black-600">Update recipient: {{ $recipient->name }}</p>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('invoice.email-recipients.update', $recipient->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <select id="store_id" 
                    ...
                    @foreach($stores as $store)
                        <option value="{{ $store->id }}" {{ old('store_id', $recipient->store_id) == $store->id ? 'selected' : '' }}>
            ...
            <div class="mb-6">
                <div class="flex items-center">
                    <input type="checkbox" 
                           ...
                           name="is_default" 
                           value="1"
                           {{ old('is_default', $recipient->is_default) ? 'checked' : '' }}
