{{-- resources/views/workbooks/rows/create.blade.php --}}
@extends('layouts.app')

@section('title', 'Add Row · ' . $workbook->name)
...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <nav class="mb-6">
        <ol class="flex items-center space-x-2 text-sm text-black-600">
            ...
            <li class="font-semibold text-black-900">Add Row</li>
        </ol>
    </nav>
    ...
    <div class="bg-orange-50 shadow-lg rounded-2xl border border-orange-200 overflow-hidden">
        ...
        <!-- Progress / Helper -->
        <div class="px-6 py-3 bg-orange-75 border-b border-orange-200">
            <div class="flex items-center justify-between text-xs">
                <span class="text-black-600">Step 1 of 1</span>
                <span class="font-medium text-orange-700">Required fields marked</span>
            </div>
        </div>

        <!-- Form -->
        <form action="{{ route('workbooks.rows.store', [$workbook->folder, $workbook]) }}" method="POST" class="p-6 space-y-8">
            @csrf
                    ...
                    <div class="space-y-2 group">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute right-3 top-1/2 -translate-y-1/2">
                                <span class="text-xs text-black-400 char-counter" style="display:none;">0</span>
                            </div>
                        </div>

                        <p class="text-xs text-black-500 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                            Enter data for {{ strtolower($column->name) }} column
                        </p>
                    </div>
                @endforeach
            </div>

            <!-- Sticky-ish footer area -->
