    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('admin.equipment.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">Leave blank for global/shared equipment.</p>
            ...
            <div>
                ...
                <input type="text" name="type" value="{{ old('type') }}"
                       class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500"
                       placeholder="e.g. Refrigeration, HVAC, Plumbing…">
            ...
            <div>
                ...
                <textarea name="notes" rows="3"
                          class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('notes') }}</textarea>
