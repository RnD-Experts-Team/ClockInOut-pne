                    ...
                    <table class="min-w-full border-collapse" id="ticketReportTable">
                        ...
                        @foreach($maintenanceRequests as $index => $request)
                            <tr class="{{ $index % 2 == 0 ? 'bg-white' : 'bg-gray-50' }} hover:bg-[#fff4ed]">
                                ...
                                <td class="border border-gray-300 px-3 py-3 text-sm" data-sort="{{ $request->assignedTo ? $request->assignedTo->first_name . ' ' . $request->assignedTo->last_name : 'Not Assigned' }}">
                                ...
                                <td class="border border-gray-300 px-3 py-3 text-sm text-center" data-sort="{{ $request->due_date ? $request->due_date->format('Y-m-d') : '9999-12-31' }}">
