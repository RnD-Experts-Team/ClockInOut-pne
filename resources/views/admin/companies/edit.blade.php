        ...
        <div class="bg-orange-50 shadow-lg rounded-xl overflow-hidden">
            <div class="px-6 py-4 border-b border-orange-200">
                <div class="flex justify-between items-center">
                    <h2 class="text-2xl font-bold text-black-900">Edit Company - {{ $company->name }}</h2>
            ...
            <form action="{{ route('companies.update', $company) }}" method="POST" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="notes" id="notes" rows="4"
                              ...
                              placeholder="Additional notes about the company">{{ old('notes', $company->notes) }}</textarea>
                    @error('notes')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
