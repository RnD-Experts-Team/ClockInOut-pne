...
class LeaseImport implements ToModel, WithHeadingRow, WithValidation, SkipsOnError, SkipsEmptyRows, WithBatchInserts, WithChunkReading
{
    ...
    public function model(array $row)
    {
        ...
        return new Lease([
            ...
            'landlord_email' => $row['email_phone'] ?? null, // You might want to split this
            'landlord_phone' => null, // Extract from email_phone if combined
    ...
    public function rules(): array
    {
        return [
            ...
            'date_franchise_agreament_expiration_date2' => 'nullable|date',
