...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('leases', function (Blueprint $table) {
            // Add renewal date column after initial_lease_expiration_date
            $table->date('renewal_date')->nullable()->after('initial_lease_expiration_date');
    ...
    public function down(): void
    {
        Schema::table('leases', function (Blueprint $table) {
            ...
            // Drop indexes
            $table->dropIndex(['leases_renewal_date_index']);
            $table->dropIndex(['leases_renewal_date_renewal_reminder_sent_index']);
